...
Route.group(() => {
    ...
    Route.post('/get_products_unpublished', 'ServiceController.get_products_unpublished')
    Route.post('/update_products_unpublished', 'ServiceController.update_products_unpublished')
    Route.post('/get_products_oos', 'ServiceController.get_products_oos')
    Route.post('/get_orders', 'ServiceController.get_orders')
    Route.post('/update_product_excluded', 'ServiceController.update_product_excluded')
    Route.post('/update_products_status', 'ServiceController.update_products_status')
    ...
    Route.get('/get_total_order_amount', 'ServiceController.get_total_order_amount')
    Route.get('/get_total_order_count', 'ServiceController.get_total_order_count')
    Route.get('/get_total_order_amount_month', 'ServiceController.get_total_order_amount_month')
    Route.get('/get_total_order_count_month', 'ServiceController.get_total_order_count_month')
    Route.get('/get_list_of_transactions', 'ServiceController.get_list_of_transactions')
    Route.get('/get_transaction_details', 'ServiceController.get_transaction_details')
}).prefix('api')